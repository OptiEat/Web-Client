...
const listOfFunnyMessages = ["Cooking the chicken breast", "Marinating the meats", "Salting the eggs", "Dicing the onions and tomatoes", ""]
function Plan(props){
    ...
    return(
      <Layout>
          <div className="Plan">
            ...
            <Button className="regenMeal" loading={loading} onClick={handleClick}>Regenerate Meal Plan</Button>
